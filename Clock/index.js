...
let londonclockv1 = document.getElementById('londonclockv1');
...
setInterval(function () {
    ...
    londonclock.innerHTML=jsClock({lang:'en-US',zone:{timeZone:'Europe/London'}});
    //-------------------------------------
    ...
    ReactDOM.render(reactClock({lang:'en-US',zone:{timeZone:'Europe/London'}}),londonclockv1)
}, 1000);